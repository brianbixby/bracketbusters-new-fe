        ...
        <div className="logo">
          <Link
            ...
            className={classToggler({
              link: true,
              'logo-text': true,
              'intro-text': !props.userAuth,
            })}
          >
            <span className="bracket">BRACKET</span>
            <span className="light">BUSTERS</span>
          </Link>
        </div>
          ...
          <li className="social dropdown">
            {renderIf(
              ...
              <div>
                ...
                <div
                  className={
                    visible ? 'slideIn dropdownDiv' : 'slideOut dropdownDiv'
                  }
                >
                  <Link
                    to={profileLink}
                  ...
                  <p className="logout link" onClick={handleSignOut}>
                    logout
                  </p>
                </div>
              </div>
