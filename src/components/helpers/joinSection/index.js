            ...
            <div>
              ...
              {renderIf(
                ...
                <p className="joinTextSubtitle">
                  Take control of the NBA playoffs! Pick the winning teams and
                  earn points based on their real-life performance. Compete with
                  others in your league to be crowned champion.
                </p>
              )}
              {renderIf(
                this.props.joinType === 'group',
                <p className="joinTextSubtitle">
                  Get the latest news, insight and predictions! Join a group and
                  get the 411 on latest updates on and off the court. Debate,
                  discuss and cheer on your favorite team.
                </p>
              )}
            </div>
          </div>
