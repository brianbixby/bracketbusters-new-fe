    ...
    return (
      <div>
        <div className='createOuterInner'>
          {renderIf(props.formType === 'league',
            <div className='outer'>
              ...
              <div className='outerRight'>
                <p className='seeAll' onClick={redirect}>See All</p>
              </div>
            </div>
          )}
          {renderIf(props.formType === 'group',
            <div className='outer'>
              <div className='outerLeft'>
          ...
          <div className='createMain'>
            <div className='createMainWrapper' onClick={props.handleCreate}>
              <div className='createMainContent'>
                ...
                <div>
                  <p className='createMainTitle'> Create a {props.formType}, and bring your friends! </p>
                  {renderIf(props.formType === 'league',
        ...
        <JoinSection joinType={props.formType} handleRedirect={props.handleRedirect}/>
        {renderIf(props.joinedItems.length > 0,
          <div className='container'>
            <div className='sliderOuter'>
              <div className='sliderOuterWrapper'>
                {props.joinedItems.map(joinedItem => {
                  let boundJoinedItemClick = props.handlejoinedItemClick.bind(this, joinedItem);
                  return <div className='sliderInnerWrapper' key={joinedItem._id}>
                    <div className='cardOuter' onClick={boundJoinedItemClick}>
                      <Slider joinedItem={joinedItem} formType={props.formType} />
                    </div>
                  </div>;
                })}
              </div>
